...
is not deployed and Live acceptance is not yet verified. Do not describe the
...
two Sandbox credential values. Preview's webhook subscription is still pending.
