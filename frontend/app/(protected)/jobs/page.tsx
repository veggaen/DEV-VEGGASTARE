    ...
    <div className="relative min-h-[calc(100vh-var(--app-header-offset,0px))] overflow-x-hidden">
      ...
      <div className="pointer-events-none absolute inset-0">
        ...
        <motion.div
          ...
          style={{
            background: "radial-gradient(closest-side, rgba(34,197,94,0.12), rgba(236,72,153,0.08), transparent 72%)",
            mixBlendMode: "screen",
          }}
        />
      </div>
          ...
          <div className="flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-between mb-8">
            <div className="flex items-center gap-3">
              <select
                ...
                className="h-10 rounded-xl border border-white/10 bg-white/5 px-4 text-sm text-white/90 outline-none transition-colors hover:bg-white/10 focus:border-indigo-500/50"
              >
            ...
            <div className="relative">
              <input
                ...
                className="h-10 w-full rounded-xl border border-white/10 bg-white/5 pl-4 pr-10 text-sm text-white placeholder-white/40 outline-none transition-colors hover:bg-white/10 focus:border-indigo-500/50 sm:w-64"
              />
              <svg className="absolute right-3 top-1/2 h-4 w-4 -translate-y-1/2 text-white/40" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                ...
                >
                  ...
                  >
                    <div className="flex flex-col gap-4 sm:flex-row sm:items-start sm:justify-between">
                      <div className="min-w-0 flex-1">
                        <div className="flex items-center gap-3 mb-2">
                          ...
                          <div className="min-w-0">
                            <span className="text-sm text-white/60">{job.user?.name || 'Anonymous'}</span>
                      ...
                      {job.images[0] && (
                        <div className="relative h-20 w-20 flex-shrink-0 overflow-hidden rounded-xl bg-white/5 sm:h-24 sm:w-24">
                          <Image
                            src={job.images[0]}
                            alt="Request preview"
                            fill
