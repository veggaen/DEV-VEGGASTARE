    ...
    return (
      <div className={`space-y-4 w-full overflow-y-auto`}>
        <div className='flex flex-col justify-center items-center'>
          <h1 className='text-4xl font-extrabold text-transparent bg-clip-text bg-gradient-to-bl dark:from-slate-300 from-slate-500 dark:to-slate-300 to-neutral-900 text-pretty'>Products Page</h1>
        </div>
