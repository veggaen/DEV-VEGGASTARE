...
const MyPageLogin = async () => {
  ...
  // old style. // bg-gradient-to-tr dark:from-slate-600 dark:to-slate-800 from-blue-100 via-gray-200 to-blue-200
  return (
    <div className="flex flex-col justify-start items-center w-full mt-4 p-4 sm:p-8"> 
