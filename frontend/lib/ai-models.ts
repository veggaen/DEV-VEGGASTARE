...
export const AI_PROVIDERS: AiProviderDef[] = [
  ...
  },
  {
    ...
    models: [
      ...
      { value: "openai/gpt-oss-20b",      label: "GPT-OSS 20B",               description: "Fast, cost-efficient open-weight model",                        capabilities: ["fast", "cheap", "reasoning"],  group: "standard",    contextSize: "128K" },
