  ...
  return (
    <div className="mb-8">
      <div className="flex items-center gap-2 mb-4">
        ...
        <span className="text-sm text-slate-500 dark:text-slate-400">({companies.length})</span>
      </div>
      ...
      <div className="mx-auto w-full max-w-screen-2xl px-4 pb-10 pt-6">
        ...
        <div className="flex flex-col gap-2 sm:flex-row sm:items-end sm:justify-between mb-8">
          ...
          <Link
            ...
            className="inline-flex items-center justify-center gap-2 rounded-lg border border-black/10 bg-black/5 px-4 py-2 text-sm font-semibold text-slate-900 transition-colors hover:bg-black/10 dark:border-white/10 dark:bg-white/[0.04] dark:text-white dark:hover:bg-white/[0.07]"
          >
        ...
        {hasNoCompanyRelation && (
          <div className="mb-10 rounded-2xl border-2 border-dashed border-slate-300 dark:border-slate-700 bg-slate-50/50 dark:bg-slate-900/30 p-8 text-center">
            <FiHome className="mx-auto h-12 w-12 text-slate-400 dark:text-slate-500 mb-4" />
