...
const AI_PROVIDER_OPTIONS: AiProviderOptionDef[] = [
  {
    ...
    models: [
      ...
      { value: "openai/gpt-oss-120b",     label: "GPT-OSS 120B",  description: "Open-weight reasoning", capabilities: ["reasoning", "tools"], group: "recommended" },
      { value: "openai/gpt-oss-20b",      label: "GPT-OSS 20B",   description: "Fast open-weight model", capabilities: ["fast", "cheap", "reasoning"], group: "standard" },
  ...
  },
  {
    ...
    models: [
      ...
      { value: "anthropic/claude-sonnet-4.6",           label: "Claude Sonnet 4.6",  description: "Great reasoning",       capabilities: ["reasoning", "tools"], group: "recommended" },
      { value: "google/gemini-3.8-flash",               label: "Gemini 3.8 Flash",   description: "Google flagship",       capabilities: ["vision", "tools", "long-context", "fast"], group: "recommended" },
  ...
  },
  {
    ...
    label: "OpenAI",
    emoji: "🧠",
    tagline: "GPT-5.6 frontier models",
    getKeyUrl: "https://platform.openai.com/api-keys",
    freeAvailable: false,
    pricingNote: "Pay-as-you-go",
    models: [
      { value: "gpt-5.6-luna",  label: "GPT-5.6 Luna",  description: "Fastest · most affordable",          isDefault: true,  capabilities: ["fast", "cheap", "vision", "tools", "reasoning"], group: "recommended", supportsThinking: true },
      { value: "gpt-5.6-terra", label: "GPT-5.6 Terra", description: "Balanced intelligence and cost",      capabilities: ["flagship", "vision", "tools", "reasoning"], group: "recommended", supportsThinking: true },
      { value: "gpt-5.6-sol",   label: "GPT-5.6 Sol",   description: "Most capable for complex work",       capabilities: ["flagship", "vision", "tools", "reasoning", "coding"], group: "recommended", supportsThinking: true },
  ...
  },
  {
    ...
    pricingNote: "Pay-as-you-go",
    models: [
      { value: "claude-sonnet-4-6",          label: "Claude Sonnet 4.6", description: "Reliable balance for everyday tasks", isDefault: true, capabilities: ["flagship", "vision", "tools", "reasoning"], group: "recommended", supportsThinking: true },
      { value: "claude-opus-4-8",            label: "Claude Opus 4.8",   description: "Most capable for ambitious work",    capabilities: ["flagship", "vision", "tools", "reasoning", "coding"], group: "recommended", supportsThinking: true },
      { value: "claude-haiku-4-5-20251001",  label: "Claude Haiku 4.5",  description: "Fastest for quick answers",           capabilities: ["fast", "cheap", "tools"], group: "standard" },
    ],
  },
  {
    value: "GROK",
    ...
    pricingNote: "Pay-as-you-go",
    models: [
      { value: "grok-4.7",    label: "Grok 4.7",    description: "Current flagship for chat and code", isDefault: true, capabilities: ["flagship", "vision", "tools", "reasoning", "coding"], group: "recommended", supportsThinking: true },
    ],
  },
  {
    value: "GOOGLE",
    label: "Google",
    emoji: "🔷",
    tagline: "Gemini 3 · long context · multimodal",
    getKeyUrl: "https://aistudio.google.com/apikey",
    freeAvailable: true,
    pricingNote: "Free tier + pay-as-you-go",
    models: [
      { value: "gemini-3.8-flash",      label: "Gemini 3.8 Flash",      description: "Latest stable Flash · highly capable", isDefault: true, capabilities: ["flagship", "vision", "tools", "reasoning", "fast", "long-context"], group: "recommended", supportsThinking: true },
      { value: "gemini-3.7-flash",      label: "Gemini 3.7 Flash",      description: "Stable previous generation",                         capabilities: ["vision", "tools", "fast", "long-context"], group: "recommended" },
      { value: "gemini-3.6-flash",      label: "Gemini 3.6 Flash",      description: "Balanced everyday model",                            capabilities: ["vision", "tools", "fast", "long-context"], group: "standard" },
      { value: "gemini-3.5-flash-lite", label: "Gemini 3.5 Flash-Lite", description: "Lowest latency and cost",                           capabilities: ["fast", "cheap"], group: "standard" },
    ],
  },
];
