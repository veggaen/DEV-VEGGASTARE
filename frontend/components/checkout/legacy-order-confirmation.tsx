'use client';
/** @fileOverview Compatibility view for orders outside verified reviewer checkout. @stability experimental */
    ...
    <section className="mx-auto w-full max-w-3xl p-4 lg:p-8">
      <section className="auth-card-enter mb-6 border-y border-emerald-500/40 py-6">
        ...
        <p className="mt-2 text-sm text-muted-foreground">
          Order ID: <span className="break-all font-mono text-foreground">{orderDetails.id}</span>
        </p>
      </section>
