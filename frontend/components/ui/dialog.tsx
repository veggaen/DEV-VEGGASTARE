...
>(({ className, ...props }, ref) => (
  <DialogPrimitive.Overlay
    ref={ref}
    className={cn(
      // Frosted scrim (blur + softer black) — modals feel layered, not blacked-out
...
interface DialogContentProps extends React.ComponentPropsWithoutRef<typeof DialogPrimitive.Content> {
  /** Accessible name for the dialog when no visible DialogTitle is present */
...
const DialogContent = React.forwardRef<
  ...
  DialogContentProps
>(({ className, children, accessibleTitle, hideCloseButton, ...props }, ref) => (
  <DialogPortal>
    <DialogOverlay />
    <DialogPrimitive.Content
      ref={ref}
      className={cn(
        // Elevated modal surface: token border, e3 shadow, slightly larger radius
