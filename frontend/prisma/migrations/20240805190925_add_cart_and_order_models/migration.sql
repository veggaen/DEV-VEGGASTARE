...
-- CreateEnum
CREATE TYPE "PaymentMethod" AS ENUM ('METAMASK', 'PAYPAL', 'COINBASE', 'VISA');
...
-- AlterTable
ALTER TABLE "MonthlyReport" ALTER COLUMN "updatedAt" SET DEFAULT CURRENT_TIMESTAMP;
...
-- AlterTable
ALTER TABLE "SpecificationsDetails" ALTER COLUMN "updatedAt" SET DEFAULT CURRENT_TIMESTAMP;
